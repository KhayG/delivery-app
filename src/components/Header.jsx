                ...
                <div className="relative">
                    ...
                    />
                    {
                        isMenu && (
                            ...
                            >
                                { user && user.email === "jacksonvineamnotlos@gmail.com" && (
                                    <Link to={"/createItem"}>
                ...
                />
                {
                    isMenu && (
                        ...
                        >
                            ...
                            <p className="px-4 py-2 flex items-center justify-center bg-gray-200 gap-3 cursor-pointer hover:bg-gray-300 transition-all duration-100 ease-in-out text-textColor text-base" onClick={logout}>Logout <MdLogout /></p>
                        </motion.div>
                    )
                }
            </div>    
